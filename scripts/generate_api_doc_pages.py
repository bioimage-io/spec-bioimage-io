...
for path in sorted(src.rglob("*.py")):
    ...
    # Build a flat nav for API Reference: one entry for bioimageio.spec and
    # one entry per top-level submodule under bioimageio.spec. No subsections.
    assert parts[0:2] == ("bioimageio", "spec")
    if len(parts) == 2:
        # Landing page for bioimageio.spec at api/index.md
