...
if __name__ == "__main__":
    ...
    export_json_schema_from_schema(dist, bioimageio.spec.dataset)
    ...
    export_json_schema_from_schema(dist, bioimageio.spec.workflow)
    export_json_schema_from_schema(dist, bioimageio.spec.workflow.v0_2)
