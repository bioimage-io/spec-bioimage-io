...
LICENSE_ID_MODULE_PATH = PROJECT_ROOT / "bioimageio/spec/_internal/types/_generated_spdx_license_type.py"
...
def main(*, tag: str):
    ...
    black_config = black.files.parse_pyproject_toml(str(PROJECT_ROOT / "pyproject.toml"))
