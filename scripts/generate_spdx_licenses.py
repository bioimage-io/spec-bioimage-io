...
LICENSE_ID_MODULE_PATH = (
    PROJECT_ROOT / "src/bioimageio/spec/_internal/_generated_spdx_license_literals.py"
)
LICENSE_ID_MODULE_TEMPLATE = """# This file was generated by scripts/generate_spdx_licenses.py
...
def parse_args():
    p = ArgumentParser(description="script that generates spdx license literals")
