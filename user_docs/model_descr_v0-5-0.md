...
Union of
- Path (PathType(path_type='file'); Predicate(func=<function PurePath.is_absolute at 0x76cd46041940>))
...
Optional[AxisId (Predicate(func=<function <lambda> at 0x76cd364b5300>))]
...
(WithSuffix(suffix=('.gif', '.jpeg', '.jpg', '.png', '.svg'), case_sensitive=False); PlainSerializer(func=<function _package at 0x76cd42e0dbc0>, return_type=PydanticUndefined, when_used='unless-none'))
...
- Union of
  ...
  (AfterValidator(wo_special_file_name); PlainSerializer(func=<function _package at 0x76cd42e0dbc0>, return_type=PydanticUndefined, when_used='unless-none'))
...
## `timestamp`<sub> _internal.types.Datetime</sub> ≝ `root=datetime.datetime(2024, 3, 15, 22, 33, 3, 977560)`
...
(AfterValidator(_validate_md_suffix); PlainSerializer(func=<function _package at 0x76cd42e0dbc0>, return_type=PydanticUndefined, when_used='unless-none'))]
