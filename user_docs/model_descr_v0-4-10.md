...
(AfterValidator(func=<function wo_special_file_name at 0x7f93c10eeac0>); PlainSerializer(func=<function _package at 0x7f93c347ae80>, return_type=PydanticUndefined, when_used='unless-none'); WithSuffix(suffix='.npy', case_sensitive=True))
