...
(AfterValidator(func=<function wo_special_file_name at 0x7faee809aac0>); PlainSerializer(func=<function _package at 0x7faeea6cee80>, return_type=PydanticUndefined, when_used='unless-none'); WithSuffix(suffix='.npy', case_sensitive=True))
