...
(AfterValidator(func=<function wo_special_file_name at 0x77a35d322ac0>); PlainSerializer(func=<function _package at 0x77a35fa16f20>, return_type=PydanticUndefined, when_used='unless-none'); WithSuffix(suffix='.npy', case_sensitive=True))
