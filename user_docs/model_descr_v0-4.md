...
(AfterValidator(func=<function wo_special_file_name at 0x7f0027326ac0>); PlainSerializer(func=<function _package at 0x7f00296cae80>, return_type=PydanticUndefined, when_used='unless-none'); WithSuffix(suffix='.npy', case_sensitive=True))
