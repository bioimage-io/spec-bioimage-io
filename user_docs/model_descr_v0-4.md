...
<details><summary>Sequence[Union[Path*, _internal.url.HttpUrl, _internal.io.RelativeFilePath, Url*]*]
...
(union_mode='left_to_right'; AfterValidator(wo_special_file_name); PlainSerializer(func=<function _package at 0x7f70715c1ee0>, return_type=PydanticUndefined, when_used='unless-none'); WithSuffix(suffix='.npy', case_sensitive=True))
