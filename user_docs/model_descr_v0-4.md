...
(AfterValidator(func=<function wo_special_file_name at 0x7efd5e6beac0>); PlainSerializer(func=<function _package at 0x7efd60d9ee80>, return_type=PydanticUndefined, when_used='unless-none'); WithSuffix(suffix='.npy', case_sensitive=True))
