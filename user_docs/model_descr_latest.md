...
## `timestamp`<sub> _internal.types.Datetime</sub> ≝ `root=datetime.datetime(2024, 10, 24, 14, 48, 20, 446146)`
...
(union_mode='left_to_right'; AfterValidator(_validate_md_suffix); PlainSerializer(func=<function _package at 0x7f15e8d862a0>, return_type=PydanticUndefined, when_used='unless-none'))]
