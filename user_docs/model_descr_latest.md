...
## `timestamp`<sub> _internal.types.Datetime</sub> ≝ `root=datetime.datetime(2024, 3, 23, 19, 55, 2, 2368)`
...
(union_mode='left_to_right'; AfterValidator(_validate_md_suffix); PlainSerializer(func=<function _package at 0x7f931584afc0>, return_type=PydanticUndefined, when_used='unless-none'))]
