...
## `id`<sub> ApplicationId | None</sub> ≝ `None`
...
## `parent`<sub> ApplicationId | None</sub> ≝ `None`
...
(union_mode='left_to_right'; AfterValidator(wo_special_file_name); PrettyPlainSerializer(func=<function _package_serializer at 0x7f78a62851c0>, return_type=PydanticUndefined, when_used='unless-none'))]
