...
- differentiate reproducibility tolerance for discrete and continuous outputs.
- fix #769 (remove effective 2GB resource package limit)
...
- remove torchaudio from recommended environments
