...
html_result: "str | Exception" = generate_docs(raw_type=SpecificResourceDescr, root_path=["Delivery"])
if isinstance(html_result, Exception):
    ...
    docs_output_path = Path(__file__).parent.parent.parent.parent / f"dist/interactive_docs_{MAJOR_MINOR_VERSION}.html"
