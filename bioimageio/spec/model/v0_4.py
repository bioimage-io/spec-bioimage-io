...
from bioimageio.spec.general.v0_2 import GeneralDescriptionBaseNoSource
...
class Model(GeneralDescriptionBaseNoSource):
    ...
    model_config = GeneralDescriptionBaseNoSource.model_config | dict(
