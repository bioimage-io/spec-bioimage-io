...
_v_strings_before_latest = ["v0_3_0", "v0_3_1", "v0_3_2", "v0_3_3", "v0_3_6", "v0_4_0", "v0_4_9"]


@pytest.fixture(params=[*_v_strings_before_latest, "latest"])
